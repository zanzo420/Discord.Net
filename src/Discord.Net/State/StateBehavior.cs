namespace Discord
{
    public enum StateBehavior
    {
        ...
        /// </summary>
        /// <seealso cref="DiscordClientConfig.DefaultStateBehavior"/>
        Default = 0,
        /// <summary>
        ...
        CacheOnly = 2,
        /// <summary>
        ///     The entity will be downloaded from the Discord REST API if the <see cref="IStateProvider"/> on hand cannot locate it.
        /// </summary>
        AllowDownload = 3,
        /// <summary>
        ///     The entity will be downloaded from the Discord REST API. The local <see cref="IStateProvider"/> will not be contacted to find the entity.
        /// </summary>
        DownloadOnly = 4
    }
}
